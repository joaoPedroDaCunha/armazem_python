...
def prog():
    try:
        threadtxt = Thread(target=txt, args=(entry_date.get() or None,entry_horario.get() or None,entry_nome.get() or None,entry_telefone.get() or None,entry_placa.get() or None,entry_tipo.get() or None,entry_trans.get() or None,combobox_forn.get() or None,combobox_prod.get() or None,combobox_carga.get() or None,entry_nfsal1.get() or None,int(entry_peso1.get() or "0"),entry_nfsal2.get() or None,int(entry_peso2.get() or "0"),entry_nfsal3.get() or None,int(entry_peso3.get() or "0"),checkbox_lote2_var.get() or None,checkbox_lote3_var.get() or None))
        threadtxt.daemon
        threadtxt.start()
